...
// @name        hoohooTV
// @namespace   hoohooTV
// @include     /^https?:\/\/[^/]*hoohoo[^/]*\/.*$/
// @grant       none
// @version     1.0
// @author      -
// @description hoohooTV 광고 제거 및 UI 변경
// ==/UserScript==
...
    // =======================================================
    ...
    const elementsToRemove = [
        '.front-master', '.members-profile-master', '.partner', '.rhkd', '.footer', '.utility-button', '.datetime-hit', '.view-comment-area', '#footer'
    ];
